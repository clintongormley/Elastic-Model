...
A "Domain" is used for creating, updating or deleting individual objects
or L<Documents|/Document>. The C<< $domain->name >> can be the name
of an L</Index> or an L<Index Alias|/Alias> in
ElasticSearch. A domain can only belong to a single L<namespace|/Namespace>.
...
BlogPosts that have been published this year.  This would be achieved
with a Range filter.
