...
Elasticsearch cluster.  The last line is the equivalent of:
    ...
    my $es     = Search::Elasticsearch::Compat->new( servers => 'localhost:9200' );
...
L<facets|http://www.elasticsearch.org/guide/en/elasticsearch/reference/0.90/search-facets.html>,
