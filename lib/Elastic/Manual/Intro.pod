...
L<index|Elastic::Manual::Terminology/Index> (like a database in a relation DB)
in ElasticSearch.
...
See L<Elastic::Manual::Conflicts> for how to deal with version conflicts.
