...
Elastic::Model is not compatible with Elasticsearch 2.x.  L<Search::Elasticsearch>,
however, defaults to using a 2.x compatible client: C<2_0::Direct>.  You should specify
